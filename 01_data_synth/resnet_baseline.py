...
train_dataset = SpatialDataset(folder='/rhome/msaee007/bigdata/pointnet_data/p1_real_data', is_train=True,  outputs=outputs, parametrized=True, histogram=True, with_noise=False, rotate=False)
val_dataset = SpatialDataset(folder='/rhome/msaee007/bigdata/pointnet_data/p1_real_data', is_train=False, outputs=outputs, parametrized=True, histogram=True, with_noise=False, rotate=False)
...
for i in range(1,max_epochs+1):
    ...
    best_wmape = val_step(model, i, val_loader, 'resnet_baseline_weather', outputs, best_wmape)
